...
public class TaxReturnController : ControllerBase
{
    ...
    [HttpPost(Name = "CalculateDataRecord")]
    ...
    private DataRecord getDataRecordJsonString(string postString)
    {
        ...
        var mock = "{\"DataRecordId\":\"1\",\"RecordName\":\"federal\",\"Sections\":[{\"SectionName\":\"personalinformation\",\"DataFields\":[{\"FieldName\":\"firstName\",\"FieldBinding\":\"federal.personalinformation.firstName\",\"FieldValue\":\"Adam\",\"FieldType\":\"input\",\"DataType\":\"string\"},{\"FieldName\":\"lastName\",\"FieldBinding\":\"federal.personalinformation.lastName\",\"FieldValue\":\"Smith\",\"FieldType\":\"input\",\"DataType\":\"string\"},{\"FieldName\":\"fullName\",\"FieldValue\":\"\",\"FieldType\":\"calculated\",\"FataType\":\"string\",\"CalculationExpression\":\"'MR.' + '{{federal.personalinformation.firstName}}' + ' ' + '{{federal.personalinformation.lastName}}'\",\"ExpressionToExecute\":\"\"}]},{\"SectionName\":\"income\",\"DataFields\":[{\"FieldName\":\"net\",\"FieldBinding\":\"federal.income.net\",\"FieldValue\":\"1100\",\"FieldType\":\"double\",\"DataType\":\"int\"},{\"FieldName\":\"tax\",\"FieldValue\":\"\",\"FieldType\":\"calculated\",\"DataType\":\"double\",\"CalculationExpression\":\"{{federal.income.net}} * 0.5\",\"ExpressionToExecute\":\"\"}]}]}";
