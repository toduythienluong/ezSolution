...
public class TaxReturnController : ControllerBase
{
    ...
    private DataRecord getDataRecordJsonString(string postString)
    {
        ...
        var mock = "{\"DataRecordId\":\"102340\",\"RecordName\":\"federal\",\"Sections\":[{\"SectionName\":\"personalinformation\",\"DataFields\":[{\"FieldName\":\"firstName\",\"FieldValue\":\"Adam\",\"FieldType\":\"input\",\"DataType\":\"string\"},{\"FieldName\":\"lastName\",\"FieldValue\":\"Smith\",\"FieldType\":\"input\",\"DataType\":\"string\"},{\"FieldName\":\"fullName\",\"FieldValue\":\"\",\"FieldType\":\"calculated\",\"DataType\":\"string\",\"CalculationExpression\":\"'{{federal.personalinformation.firstName}}' + ' ' + '{{federal.personalinformation.lastName}}'\",\"ExpressionToExecute\":\"\"}]},{\"SectionName\":\"income\",\"DataFields\":[{\"FieldName\":\"net\",\"FieldValue\":\"1100\",\"FieldType\":\"double\",\"DataType\":\"int\"},{\"FieldName\":\"tax\",\"FieldValue\":\"\",\"FieldType\":\"calculated\",\"DataType\":\"double\",\"CalculationExpression\":\"{{federal.income.net}} * 0.1\",\"ExpressionToExecute\":\"\"}]}]}";
